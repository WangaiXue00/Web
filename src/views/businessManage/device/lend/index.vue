<template>
  <div class="assistant">
    <div class="top-form">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item class="table-add">
          <el-button type="primary" @click="dialogVisible=true" icon="el-icon-circle-plus-outline" size="small">添加出借信息</el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <!-- 查看表格内容的对话框 -->
    <el-dialog title="查看当前出借管理记录" :visible.sync="viewVisible" width="60%">
      <el-descriptions>
        <el-descriptions-item label="设备机编号">{{ viewForm.sbjbh }}</el-descriptions-item>
        ...
        <el-descriptions-item label="借贷人">{{ viewForm.jdr }}</el-descriptions-item>

        <el-descriptions-item label="借贷人电话">{{ viewForm.jdrdh }}</el-descriptions-item>
        <el-descriptions-item label="出借时间">{{ viewForm.cjsj }}</el-descriptions-item>

        <el-descriptions-item label="是否归还">{{ viewForm.sfgh }}</el-descriptions-item>
    ...
    <!-- 修改表格内容的对话框 -->
    <el-dialog title="修改当前出借管理记录" :visible.sync="editVisible" width="50%">
    ...
    <div>
      ...
      :header-cell-style="{background: '#165DFF',color:'#fff',font:'500 14px PingFang SC'}"
        ...
        <el-table-column prop="sbjbh" label="设备机编号">
        </el-table-column>
        <el-table-column prop="sbmc" label="设备名称">
        </el-table-column>
        <el-table-column prop="sbxh" label="设备型号">
        </el-table-column>
        <el-table-column prop="jdr" label="借贷人">
        </el-table-column>
        <el-table-column prop="jdrdh" label="借贷人电话">
        </el-table-column>
        <el-table-column prop="cjsj" label="出借时间">
        </el-table-column>
        <el-table-column prop="sfgh" label="是否归还">
        </el-table-column>
