<template>
  <div class="assistant">
    <div class="top-form">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item label="设备型号:">
          <el-input style="width: 150px;" v-model="formInline.sbxh" placeholder="请输入设备型号" size="small"></el-input>
        </el-form-item>
        ...
        <el-form-item label="设备品牌:">
          <el-input style="width: 130px;" v-model="formInline.sbpp" placeholder="请输入设备品牌" size="small"></el-input>
        </el-form-item>
        ...
        <el-form-item class="table-add">
          <el-button type="primary" @click="dialogVisible=true" icon="el-icon-circle-plus-outline" size="small">添加备用机</el-button>
        </el-form-item>
      </el-form>
    </div>
    ...
    <!-- 查看表格内容的对话框 -->
    <el-dialog title="查看当前备用机管理记录" :visible.sync="viewVisible" width="60%">
      <el-descriptions>
        <el-descriptions-item label="系统编号">{{ viewForm.xtbh }}</el-descriptions-item>
        <el-descriptions-item label="设备名称">{{ viewForm.sbmc }}</el-descriptions-item>
        <el-descriptions-item label="设备型号">{{ viewForm.sbxh }}</el-descriptions-item>
        <el-descriptions-item label="二级类别">{{ viewForm.ejlb }}</el-descriptions-item>

        <el-descriptions-item label="设备品牌">{{ viewForm.sbpp }}</el-descriptions-item>
        <el-descriptions-item label="保管负责人">{{ viewForm.bgfzr }}</el-descriptions-item>

        <el-descriptions-item label="负责人电话">{{ viewForm.fzrdh }}</el-descriptions-item>
        <el-descriptions-item label="购买时间">{{ viewForm.gmsj }}</el-descriptions-item>
        <el-descriptions-item label="存放地点">{{ viewForm.cfdd }}</el-descriptions-item>
        <el-descriptions-item label="设备状态">{{ viewForm.sbzt }}</el-descriptions-item>
    ...
    <!-- 修改表格内容的对话框 -->
    <el-dialog title="修改当前备用机管理记录" :visible.sync="editVisible" width="50%">
    ...
    <div>
      ...
      :header-cell-style="{background: '#165DFF',color:'#fff',font:'500 14px PingFang SC'}"
       @row-dblclick="tableClick" style="width: 100%;line-height: 10px;">
        ...
        <el-table-column prop="xtbh" label="系统编号">
        </el-table-column>
        <el-table-column prop="sbmc" label="设备名称">
        </el-table-column>
        <el-table-column prop="sbxh" label="设备型号">
        </el-table-column>
        <el-table-column prop="ejlb" label="二级类别">
        </el-table-column>
        <el-table-column prop="sbpp" label="设备品牌">
        </el-table-column>
        <el-table-column prop="bgfzr" label="保管负责人">
        </el-table-column>
        <el-table-column prop="fzrdh" label="负责人电话">
        </el-table-column>
        <el-table-column prop="gmsj" label="购买时间">
        </el-table-column>
        <el-table-column prop="cfdd" label="存放地点">
        </el-table-column>
