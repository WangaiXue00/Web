<template>
  <div class="assistant">
    <div class="top-form">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        <el-form-item label="工单号:">
          <el-input style="width: 130px;" v-model="formInline.fwdh" placeholder="请输入工单号" size="small"></el-input>
        </el-form-item>
        ...
        <el-form-item label="工程师:">
          <el-input style="width: 130px;" v-model="formInline.gcs" placeholder="请输入工程师" size="small"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="inquirer" icon="el-icon-search" size="small">查询</el-button>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="el-icon-printer" size="small">工单打印</el-button>
        </el-form-item>
    ...
    <!-- 新增表格的对话框 -->
    <el-dialog title="新增" :append-to-body="true" :visible.sync="dialogVisible" width="50%" :before-close="handleClose">
    ...
    <!-- 查看表格内容的对话框 -->
    <el-dialog title="查看维修派工工单" :append-to-body="true" :visible.sync="viewVisible" width="60%">
      <el-descriptions>
        ...
        <el-descriptions-item label="报修时间">{{ viewForm.bxsj }}</el-descriptions-item>
        ...
        <el-descriptions-item label="报修电话">{{ viewForm.bxdh }}</el-descriptions-item>
      ...
      <el-descriptions>
        ...
        <el-descriptions-item label="报修期">{{ viewForm.bj }}</el-descriptions-item>
      ...
      <h3>签到记录</h3>
      <el-descriptions>
        <el-descriptions-item label="签到时间">{{ viewForm.bxsj }}</el-descriptions-item>
        <el-descriptions-item label="签到工程师">{{ viewForm.fwdh }}</el-descriptions-item>
        <el-descriptions-item label="位置">{{ viewForm.dqzt }}</el-descriptions-item>
      </el-descriptions>
      <el-divider></el-divider>
      <h3>操作日志</h3>
      <el-descriptions>
    ...
    <!-- 修改表格内容的对话框 -->
    <el-dialog title="修改当前工单信息" :visible.sync="editVisible" width="50%">
    ...
    <div>
      ...
      :header-cell-style="{background: '#165DFF',color:'#fff',font:'500 14px PingFang SC'}"
       @row-dblclick="tableClick" style="width: 100%;line-height: 10px;">
        ...
        <el-table-column prop="bxsj" label="报修时间">
        </el-table-column>
        ...
        <el-table-column prop="bxdh" label="报修电话">
        </el-table-column>
