<template>
  <div class="assistant">
    ...
    <!-- 查看表格内容的对话框 -->
    <el-dialog title="查看员工绩效审核信息" append-to-body :visible.sync="viewVisible" width="60%">
      <el-descriptions>
        <el-descriptions-item label="姓 名">{{ viewForm.xm }}</el-descriptions-item>
        <el-descriptions-item label="业务部门">{{ viewForm.bm }}</el-descriptions-item>
        ...
        <el-descriptions-item label="2023绩效得分">{{ viewForm.jxdf }}</el-descriptions-item>
      </el-descriptions>
      <!-- <hr>
      <h3>考核明细</h3> -->
      <span slot="footer" class="dialog-footer">
    ...
    <!-- 修改表格内容的对话框 -->
    <el-dialog title="修改当前员工绩效审核信息" append-to-body :visible.sync="editVisible" width="50%">
    ...
    <div>
      ...
      :header-cell-style="{background: '#165DFF',color:'#fff',font:'500 14px PingFang SC'}"
        ...
        <el-table-column prop="bm" label="业务部门">
        </el-table-column>
